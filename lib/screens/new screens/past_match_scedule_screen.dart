...
class PastMatchScheduleScreen extends StatefulWidget {
  const PastMatchScheduleScreen({super.key});

  @override
  State<PastMatchScheduleScreen> createState() => _PastMatchScheduleScreenState();
}

class _PastMatchScheduleScreenState extends State<PastMatchScheduleScreen> {
  // Dummy data for past matches
  ...
  final List<Map<String, dynamic>> upcomingMatches = const []; // Empty list for past screen

  int _selectedIndex = 1; // 0 for Upcoming, 1 for Past
